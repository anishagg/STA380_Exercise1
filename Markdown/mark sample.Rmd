...
So the maximum loss at 5% level comes out to be `r round(min(losses),2)` using the safe portfolio. And optimum distribution of the wealth is 0.1 in SPY, 0.2 in TLT, 0.7 in LQD and nothing in the remaining two. These numbers are totally in sync with the values of standard deviation. LQD being the least volatile one, got the highest percent allocated.
