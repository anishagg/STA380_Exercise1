...
Probability of the person being a random clicker, *p*(*R**C*)=0.3
Probability of the person being a truthful clicker, *p*(*T**C*)=0.7
Using survery results, *p*(*Y**e**s*)=0.65 and *p*(*N**o*)=0.35
For random clickers, *p*(*Y**e**s*|*R**C*)=0.5

Applying rule of total probability,
*p*(*Y**e**s*)=*p*(*Y**e**s*|*T**C*)\**p*(*T**C*)+*p*(*Y**e**s*|*R**C*)\**p*(*R**C*)

All values except P(Yes|TC) are known in the above equation. Plugging in we get,
0.65 = *p*(*Y**e**s*|*T**C*)\*0.7 + 0.5 \* 0.3

Solving gives *p*(*Y**e**s*|*T**C*)= 0.7142857
...
Substituting all values give *p*(*D*|*P*)= 0.1988824
...
The maximum possible difference in rents thus comes out to be (31.22 − 25.72)= 5.5 and (27.5 − 27)= 0.5 as the minimum.
